...
public class C22HashcodeEquals {
	public static void main(String[] args) {
		...
		System.out.println(o2.hashCode());//해쉬 같고
		System.out.println(o1.equals(o2));//true 나온다
		System.out.println(o3.hashCode());//하지만 다른놈이 튀어나오면 해쉬도 다르고
		System.out.println(o1.equals(o3));//당연히 false가 나온다
	}
}
class MyClass22{
	private int id;
